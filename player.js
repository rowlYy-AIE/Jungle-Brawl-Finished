...
//		constant variables for animations
var LEFT = 0;
var RIGHT = 1;
...
Player.prototype.update = function(deltaTime)
{
	...
	{
		// apply an instaneous jump (large) vertical impulse
		ddy = ddy - JUMP;
		this.jumping = true;
		if(this.direction == LEFT)
			this.sprite.setAnimation(ANIM_JUMP_LEFT)
	...
	//testing vertically and horizontally
	...
	if (this.velocity.x > 0) {
		if ((cellright && !cell) || (celldiag && !celldown && ny)) {
			// clamp the x position to avoid hitting into the platform we just hit
