...
//define some constant values for the game state
var STATE_SPLASH = 0;
var STATE_GAME = 1;
var STATE_GAMEOVER = 2;
var STATE_WIN = 3;
...
function runSplash(deltaTime) {
    ...
    context.fillText("The Magical Adventures Of Chuck Norris", 200, 240);
}
...
var MAXDY = METER * 15
    //horizontal acceleration ---- Takes 1/2 seconds to reach maxdx
var ACCEL = MAXDX * 4;
//vertical acceleration ---- takes 1/6 of a second to stop from maxdx
...
//load the image to use for this level1
...
function cellAtPicelCoord(layer, x, y) {
    if (x < 0 || x > SCREEN_WIDTH || y < 0)
        return 1;
    //let the player drop off the bottom of the screen (kill zone)
    if (y > SCREEN_HEIGHT)
        return 0;
